...
class UnMarkPositionActing extends Component {
    ...
    return (
      <div>
        <Modal isOpen={this.props.modal} toggle={this.toggle}>
          ...
          <ModalBody>
            { <Alert color="danger">
                        Are you sure you want to unmark placement as acting? 
                    </Alert> }
                    ...
                    <tr>
                      <th colSpan="2">
                        ...
                        <i className="card-text text-danger">
                          {' '}
                          (Selected assignment will be Unmarked as acting)
                        </i>
                      </th>
                    </tr>
                  </thead>
          ...
          <ModalFooter>
            <Button color="success" onClick={() => this.createUnActing()}>
              Ok
            </Button>{' '}
