        ...
        return (
            <div>
                <Modal isOpen={this.props.modal} toggle={this.toggle}>
                    <ModalHeader toggle={this.toggle}>ReActivate Staff - {this.props.selectedStaffID + ' '}</ModalHeader>
                    <ModalBody>
                        {<Alert color="danger">Are you sure you want to ReActivate Staff?</Alert>}
