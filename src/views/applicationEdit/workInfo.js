    ...
    {props.application.firstName}  {props.application.lastName} </a>
            ...
            <CardBody className="no-padding-bottom">
                <div className="form-row" >
                    ...
                    <Col sm="12" md="6" lg="2" xl="2" className="form-group">
                        <TextInput name="education" label="Education"  disabled  value={props.application.education}  onChange={props.handleInputField} />
                    </Col>

                    <Col sm="12" md="6" lg="2" xl="2" className="form-group">
                        <TextInput name="driver" label="Driver"  disabled  value={props.application.driver}  onChange={props.handleInputField} />
                    </Col>  
                    <Col sm="12" md="6" lg="2" xl="2" className="form-group">  
                    
                        <TextInput name="dateOfBirth" label="Date Of Birth"  disabled value={props.application.dateOfBirth?moment(props.application.dateOfBirth).format("YYYY-MM-DD"):null} onChange={props.handleInputField} />
                    </Col>
                    {/* <Col sm="12" md="6" lg="2" xl="2" className="form-group">
