                ...
                <Modal isOpen={this.props.modal} toggle={this.toggle} >
                    ...
                    <ModalBody className="no-padding-bottom">
                        <Row>
                            ...
                            <TextInput name="CurrentDestination" label="Current Destination" value={this.props.positionAssign.Destination} disabled  />
                            ...
                            <Col sm="12" md="6" lg="6" xl="6">
                            <TextInput name="CurrentJobTitle" label="Current JobTitle" value={this.props.positionAssign.JobTitle} disabled  />
                                <div className="form-group form-group-select">
